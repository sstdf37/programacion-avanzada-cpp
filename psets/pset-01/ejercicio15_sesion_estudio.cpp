...
int main() {
    {
        ...
        std::cout << "Horario 1 aceptado: " << s1.setHorario(8.0, 10.0) << std::endl;

        SesionEstudio s2(90);
        std::cout << "Horario 2 aceptado: " << s2.setHorario(23.0, 22.0) << std::endl;

        SesionEstudio s3(15);
        std::cout << "Horario 3 aceptado: " << s3.setHorario(14.0, 16.0) << std::endl;
