...
int main() {
    Bombilla bombillaValida(5000.0);
    std::cout << "Vida util: " << bombillaValida.getVidaUtilHoras() << std::endl;

    Bombilla bombillaInvalida(-200.0);
    std::cout << "Vida util: " << bombillaInvalida.getVidaUtilHoras() << std::endl;
